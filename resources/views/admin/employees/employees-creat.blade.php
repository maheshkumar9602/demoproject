...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="main-content-label mg-b-5"> Create Employer</div>
                <form id="submitForm"  method="post" action="{{route('admin.employees-store')}}">
                    {{csrf_field()}}
                    <div class="row">
         ...
         $.ajax({
             ...
             success: function(data) {
                 if(data.status){
                     ...
                     successMsg('Create Employer', data.msg, btn);
                     $('#submitForm')[0].reset();
                     ...
                     errorMsg('Create Employer', 'Input Error');
                 }
                 buttonLoading('reset', $this);
                 
             },
             error: function() {
                 errorMsg('Create Employer', 'There has been an error, please alert us immediately');
                 buttonLoading('reset', $this);
             }
